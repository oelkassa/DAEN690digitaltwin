# -*- coding: utf-8 -*-
"""
Created on Thu Aug 11 17:45:27 2022
...
def testHyperParams(numLayers, numNodes, epochs, numTests, kLower, kUpper, name):
    dataMin = []
    dataMax = []
    dataMean = []
    dataMedian = []
...
def testHyperParamsHoldOut(numLayers, numNodes, epochs, numTests, kLower, kUpper, hLower, hUpper, name):
    dataMin = []
    dataMax = []
    dataMean = []
    dataMedian = []
...
result1 = testHyperParams(5, 128, 1000, 1, 0, 3, "Neural Network for 0 < k < 3")
result2 = testHyperParamsHoldOut(5, 128, 1000, 1, 0, 3, 1.2, 1.3, "Neural Network Holdout Test for 0 < k < 3") 
result3 = testHyperParams(5, 128, 1000, 1, 3, 3.6, "Neural Network for 3 < k < 3.6")
result4 = testHyperParamsHoldOut(5, 128, 1000, 1, 3, 3.6, 3.3, 3.35, "Neural Network Holdout Test for 3 < k < 3.6")
result5 = testHyperParams(5, 128, 1000, 1, 3.6, 4, "Neural Network for 3.6 < k < 4")  
result6 = testHyperParamsHoldOut(5, 128, 1000, 1, 3.6, 4, 3.7, 3.75, "Neural Network Holdout Test for 3.6 < k < 4")  
